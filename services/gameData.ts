...
// In a real app, this would be fetched from a server or local JSON file
export const GAMES_DATA: Game[] = [
  ...
  },
  {
    ...
    url: "https://kbhgames.com/game/slope", // Note: Some of these might have X-Frame options, in a real scenario we'd host them locally.
...
export const fetchGameById = (id: string): Promise<Game | undefined> => {
  return new Promise((resolve) => {
    setTimeout(() => {
